...
(such as Vampire~\cite{DBLP:conf/cav/KovacsV13}, E~\cite{schulz2002brainiac}, and SPASS~\cite{weidenbach2009spass}), were originally developed to target 
...
The approaches here are mostly instantiation-based based~\cite{Detlefs03simplify:a,MouraBjoerner07EfficientEmatchingSmtSolvers,GeBarrettTinelli07SolvingQuantifiedVerificationConditionsUsingSatisfiability,},
...
reason about quantified formulas \emph{eagerly} during the DPLL($T$) search~\cite{MouraBjoerner07EfficientEmatchingSmtSolvers}.
...
Recently, variants of the approach have been implemented in a number of successful SMT solvers~\cite{Detlefs03simplify:a,Z3,CVC4-CAV-11}.
...
and has been implemented in solvers such as \cvc and veriT~\cite{DBLP:conf/cade/BoutonODF09,DBLP:conf/cade/Barbosa16}.
