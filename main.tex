...
specify universal properties for functions to synthesize.
...
can be handled efficiently due to the development of efficient algorithms 
...
This behavior is analogous to that of quantifier-free theory solvers, which often employ
...
In the context of Figure~\ref{fig:smtq}, 
the solver will be forced to choose a new candidate model if model-based quantifier instantiation is invoked again.
\qed
\end{example}
\begin{example}
