...
\begin{itemize}
\item Section~\ref{sec:ematching} will discuss widely-used \emph{heuristic} methods based on pattern-matching,
...
As mentioned, E-matching often generates an overabundance of instantiation lemmas, many of which are irrelevant to the satisfiability of our input,
which in turn degrade the performance of the SMT solver.
...
This technique was introduced in the context of a modern SMT solving in~\cite{}, and has been implemented in a few recent systems~\cite{}.
...
on the SMT-LIB, TPTP, and Isabelle benchmark libraries\footnote{Further details are given in~\cite{}.}
...
(in the context of Figure~\ref{fig:smtq}, this is the number of calls to $\funcqi$),
and column 5 gives the number of instantiation lemmas returned in these rounds.
...
A naive approach would be to construct the set of instantiations E-matching.
