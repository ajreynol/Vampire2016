...
An approach for doing so is given in~\cite{InstLA2016}.

For linear arithmetic, a possible strategy for instantiation is the following.
...
returning conflicting instances with highest priority, then heuristic instantiations,
and finally instances that refine candidate models.
