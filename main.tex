...
$( a, R( a ) ), ( c, R( c ) )$ for $R( x )$.
Overall, E-matching returns the lemmas:
\[
...
Thus, E-matching in this example returns the lemma:
\[
\psi \Rightarrow ( P( f( b ), c ) \Rightarrow g( b ) = c
\]
\qed
\end{example}
...
In other words, when using E-matching for selecting instances of quantified formulas from $Q$, 
{\bf we learn information about ground terms in $E$}.
